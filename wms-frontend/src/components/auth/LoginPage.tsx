    ...
    <div className="flex min-h-screen items-center justify-center bg-graphite-950 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="mb-3">
            <Logo size={56} className="rounded-xl shadow-panel" />
          </div>
          <h1 className="font-display text-xl font-semibold text-paper">GUZO Import and Export</h1>
          <p className="text-sm text-steel-400">Warehouse Management System</p>
        </div>
