...
async function seed() {
  ...
  // --- Accounts ------------------------------------------------------------
  const accounts = [
    { name: "System Admin", email: "admin@guzowms.local", role: "admin", jobTitle: "System Administrator", branchCode: null },
    { name: "General Manager", email: "ceo@guzowms.local", role: "executive", jobTitle: "CEO", branchCode: null },
    { name: "Warehouse Manager", email: "manager@guzowms.local", role: "manager", jobTitle: "Branch Manager", branchCode: BRANCH_CODE },
    { name: "Store Keeper", email: "store@guzowms.local", role: "employee", jobTitle: "Store Keeper", branchCode: BRANCH_CODE },
  ];
  ...
  console.log("  admin@guzowms.local    — Admin (system/IT)");
  console.log("  ceo@guzowms.local      — Executive (company-wide read-only)");
  console.log("  manager@guzowms.local  — Manager (Addis Ababa - Main branch)");
  console.log("  store@guzowms.local    — Employee / Store Keeper (Addis Ababa - Main branch)");
